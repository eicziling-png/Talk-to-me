  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "你负责判断哪些声音有独特贡献、安排阅读顺序，并保留未来多轮参与和专家视角补充的扩展空间。",
        ...
        "Each participant must include one role: reflection, perspective, support, or question.",
        "Assign the question role to at most one participant. Other participants must not end with an open question.",
        "Assign at most one primary_responder. Other participants should be supporting_voice or listener unless questioner is needed.",
        "A participant may contribute a short natural sentence or remain silent; do not force every participant to produce a full analysis.",
        "Phase 2A may arrange at most one expert perspective supplementation, only when it adds clear value for the user.",
        "Phase 2A supplementation roles are supporting_voice or integrator; challenger is disabled.",
        "A shallow input such as hi, weather, or simple small talk must not trigger an extra voice merely to display interaction.",
        "A supplement must be materially shorter than the primary responder and must reference the primary viewpoint only as internal context.",
        "No participant may respond to, mention, quote, or agree with another expert in Phase 1.",
        "JSON shape: { participants: [{ expertSlug, focus, order, role, responseRole }], messageLimit }",
